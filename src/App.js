...
function App() {
  ...
  return (
    ...
    <Container>
          ...
          <div>
              {
                  DATASET.filter(el => el.toLowerCase()
                      .includes(search ? search.toLowerCase() : searchInput.toLowerCase()))
